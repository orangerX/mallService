...
class SecurityAndMethodPolicyMvcTest {
    ...
    void validBearerTokenAuthenticatesRequest() throws Exception {
        ...
        activeUser.setStatus(UserEntity.STATUS_ENABLED);
        when(userMapper.findById(9L)).thenReturn(activeUser);
    ...
    void disabledUserTokenIsRejectedImmediately() throws Exception {
        ...
        disabledUser.setStatus(UserEntity.STATUS_DISABLED);
        when(userMapper.findById(9L)).thenReturn(disabledUser);
