...
public interface OrderMapper {
    ...
    long countAdminPage(@Param("orderNo") String orderNo, @Param("userId") Long userId,
                        @Param("status") Integer status);

    List<AdminOrderResponse> findAdminPage(@Param("orderNo") String orderNo,
                                           @Param("userId") Long userId,
                                           @Param("status") Integer status,
                                           @Param("offset") int offset, @Param("size") int size);

    AdminOrderResponse findAdminById(@Param("id") Long id);
}
